...
| `touching_circles` | HF | ❌ | 0 | Relative Comparison |
...
| `relative_bar_compare` | Local | ❌ | 0 | Relative Comparison |
| `relative_line_compare` | Local | ❌ | 0 | Relative Comparison |
| `chart_legend_match` | Local | ❌ | 0 | Color Discrimination |
| `color_grid_odd` | Local | ❌ | 0 | Color Discrimination |
| `heatmap_cell_value` | Local | ❌ | 0 | Color Discrimination |
| `text_word_reading` | Local | ❌ | 0 | Text Reading |
| `text_number_reading` | Local | ❌ | 0 | Text Reading |
...
| `chart_data_match` | Local | ❌ | 0 | Visual-Textual Consistency |
...
- `touching_circles` HF available via `--dataset blind --tasks touching_circles` but not yet run
